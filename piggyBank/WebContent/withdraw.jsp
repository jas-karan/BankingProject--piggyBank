	...
	<table style="width:100%">
		...
		<tr>
			...
			<td style="background-color: #4d774e">
					...
					<div style="color:white; text-align:center">Withdraw Amount from Account</div>
					<form action="dowithdraw" method="post">
						<table id="inner">
							...
							<tr><td>
								<input type="submit" style="background-color: #4d774e; color: white; font-size: 15px; border:none" value="Withdraw">
							</td></tr>
						</table>
					</form>
