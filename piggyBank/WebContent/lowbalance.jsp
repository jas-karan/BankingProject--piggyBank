...
<body>
	<table style="width:100%">
		...
		<tr>
			...
			<th id="about">
				<div>
					Your Account Balance is <span style="color:#bd2717">Low</span>. Your current Balance is: <span style="font-family: 'Roboto Mono', monospace;"><%= session.getAttribute("balance") %></span> INR<br/>
