	...
	<table style="width:100%">
		...
		<tr>
			...
			<td style="background-color: #4d774e">
					...
					<div style="color:white; text-align:center">View Reports</div>
					<form action="doviewreports.jsp" method="post">
						<table id="inner">
							...
							<tr><td>
								<input type="submit" style="background-color: #4d774e; color: white; font-size: 15px; border:none" value="View">
							</td></tr>
						</table>
					</form>
