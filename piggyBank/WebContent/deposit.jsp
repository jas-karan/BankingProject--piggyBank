	...
	<table style="width:100%">
		...
		<tr>
			...
			<td style="background-color: #4d774e">
					...
					<div style="color:white; text-align:center">Deposit Amount in Account</div>
					<form action="dodeposit" method="post">
						<table id="inner">
							...
							<tr><td>
								<input type="submit" style="background-color: #4d774e; color: white; font-size: 15px; border:none" value="Deposit">
							</td></tr>
						</table>
					</form>
