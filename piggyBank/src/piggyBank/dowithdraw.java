...
public class dowithdraw extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "INSERT INTO tx_details (uname, acc_no, operation, amt,timing) VALUES ('"+uname+"',"+accno+",'Withdraw',"+amt+",'"+formattedDate+"')";
		
		int update = commonClass.update(sql);
		
		HttpSession session=request.getSession();  
        session.setAttribute("balance",bal);  
		RequestDispatcher rd=request.getRequestDispatcher("dowithdraw.jsp");  
